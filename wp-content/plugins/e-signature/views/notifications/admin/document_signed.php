                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              bgcolor="#F7FAFC"><?php echo $data['signer_name']; ?> has signed your document</td>
                          </tr>
                        </tbody>
                      </table>
                      <table width="640">
...
style="color:#cccccc;background-color:#cccccc;min-height:1px;border:none">
                              <p
                                ...
                                <br>
                                <?php echo $data['signer_name']; ?> (<?php echo $data['signer_email']; ?>) has signed your document.<br>
