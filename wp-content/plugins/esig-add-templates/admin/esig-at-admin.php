...
class ESIG_AT_Admin {
	...
	**/
	...
	public function templateupload()
		{
			...
			$documents=$api->document->fetchAllOnStatus('esig_template');
	...
	public function document_add_data($more_contents) {
		...
		$more_contents .= sprintf(__('<p id="esig_template_option">
			<a href="#" class="tooltip">
				...
				<input type="checkbox" '. $checked .' id="esig_template" name="esig_template"> Save document as template 
				<div id="esig_template_input" style="display:none;padding-left:50px;"><input type="text" name="esig_template_title" placeholder="Name of Template" value="" ></div>
			</p>', 'esig-at'));
