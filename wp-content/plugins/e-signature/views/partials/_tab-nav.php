...
<div id='esig-settings-container' class='wrap approveme_main wpd-sign' >		
    ...
    <ul>
		 	<li class='esig-extension-headimg'>
				...
				<br> 
		 <a href='?page=esign-addons-general' class='esig-extension-headlink'><?php _e('E-Sign Add-On Extensions.', 'esig' );?></a>
		<br>
...
<div class="esign-main-tab">
	<h2 class="nav-tab-wrapper">
		...
		<a class="nav-tab <?php echo $data['documents_tab_class']; ?>" href="?page=esign-docs">My Documents</a>
		<a class="nav-tab <?php echo $data['settings_tab_class']; ?>" href="?page=esign-settings">Settings</a>
        ...
        ?>
		<a class="nav-tab <?php echo $data['support_tab_class']; ?>" href="?page=esign-support-general">Premium Support</a>
       
        <?php
        if($this->setting->esign_super_admin()){  ?>
		<a class="nav-tab <?php echo $data['misc_tab_class']; ?>" href="?page=esign-misc-general">Customization</a>
		<?php } ?>
        
        <a class="nav-tab <?php echo $data['addons_tab_class']; ?>" href="?page=esign-addons">Add-Ons</a>
