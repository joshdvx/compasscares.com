	...
	**/
	...
	public function enqueue_styles() {
		...
		// If we're on a stand alone page
           ...
           echo "<link rel='stylesheet' id='jquery-style-css'  href='http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.2/themes/smoothness/jquery-ui.css?ver=4.0' type='text/css' media='all' />";
        ...
        echo "<script type='text/javascript' src='". includes_url() ."/js/jquery/ui/jquery.ui.datepicker.min.js?ver=1.10.4'></script>";
	}
