...
<div class="esign-main-tab">
 ...
 <a class="misc_link <?php echo $data['link_active']; ?>" href="admin.php?page=esign-misc-general"><?php _e('General Option', 'esig'); ?></a>  <?php echo $data['customizztion_more_links']; ?>
