    ...
    public function success_page_filter($success_msg,$args){
            ...
            if($display !="1"){
                if($success_paragraph){
                         ...
                         $success_msg = "<p class=\"success_title\" align=\"center\">Excellent work! You signed {$args['document']->document_title} like a boss.</h2> <p align='center' class='s_logo'><img src='$success_image'></p>";       
                 }
            }else {
