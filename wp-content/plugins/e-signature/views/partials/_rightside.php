                ...
                foreach($esig_plugin_list as $plugin_file => $plugin_name) 
				 {
                       ...
                       if (!array_key_exists($plugin_file,$array_Plugins))
                       {
                           ...
                           echo '<li class="li_link">
                       		<a href="http://beta.approveme.me/downloads/">'. $plugin_name  .'</a>
                        </li> ';
                       }
                 }
...
<div id="esig-support" class="postbox" style="margin-left:10px;min-width:270px">
	...
	<p> <a class="button-secondary" href="admin.php?page=esign-support-general"><?php _e('Request Premium Support', 'esig' );?></a></p>	
	...
	<a target="_blank" href="http://beta.approveme.me/wp-digital-signature-plugin-docs/"><?php _e('Quick Start Guide', 'esig' );?></a><br>
	<a target="_blank" href="http://beta.approveme.me/wp-digital-signature-plugin-docs/faq/"><?php _e('Frequently Asked Questions', 'esig' );?></a></p>
